$(document).ready(function () {
	...
	*/
	$('.add_to_cart').click(function () {
		...
		*/
		setTimeout(function () {
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + productImage + "' alt='' /></div><span>" + productName + "</span><strong .price>$39</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";
	...
	// Create a variable to store the total price of the cart
	var totalPrice = 0;

	// Loop through each product in the cart
	$('.add-cart-large').each(function (i, el) {
		// Get the price of the product
		var price = parseFloat($(el).parent().find('.price').text().replace('$', ''));
		Number(price);
	...
	$('.total-price').text('$' + totalPrice.toFixed(2)); // assuming there is an element with class "total-price" in the cart to display the total price
