	...
	$('.add_to_cart').click(function () {
		...
		*/
		setTimeout(function () {
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + productImage + "' alt='' /></div><span>" + productName + "</span><strong class='price'>39</strong></div><div class='delete-item'></div></div>";
...
function calculateTotal() {
	...
	$("#cart .cart-item").each(function () {
		...
		alert("Tổng tiền của bạn là: " + total + " $" + " Cảm ơn bạn đã mua hàng của chúng tôi")
	})
