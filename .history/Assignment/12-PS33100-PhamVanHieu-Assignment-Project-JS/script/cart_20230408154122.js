...
// // Chức năng tính tổng tiền của giỏ hàng mỗi lần nhấn "Add to cart"
// // Lấy tất cả các phần tử có class "cart-item" trong #cart
// var cartItems = $("#cart .cart-item");
// var total = 0;
// // Lặp qua từng phần tử trong cartItems để tính tổng tiền
// cartItems.each(function() {
//   // Lấy giá tiền từ phần tử hiện tại và chuyển đổi sang kiểu số
//   var price = parseFloat($(this).find("strong").text().replace("$", ""));
//   // Cộng giá tiền vào tổng
//   console.log(price);
//   total += price;
// });
// // Hiển thị tổng tiền trong #totalPrice
// $("#totalPrice").text("$" + total.toFixed(2));
// document.getElementById("totalPrice").innerHTML = "$" + total.toFixed(2);

// Tính tổng tiền sau khi thêm sản phẩm vào giỏ hàng
// $('.add_to_cart').click(function () {
//   // Lấy giá tiền của sản phẩm vừa thêm vào giỏ hàng
//   var productPrice = parseFloat($(this).siblings('.product_price').text().replace("$", ""));
//   // Cộng giá tiền vào tổng
//   total += productPrice;
//   // Hiển thị tổng tiền trong #totalPrice
