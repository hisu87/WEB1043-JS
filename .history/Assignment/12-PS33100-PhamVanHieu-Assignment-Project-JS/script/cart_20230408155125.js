$(document).ready(function () {
	...
	*/
	$('.add_to_cart').click(function () {
		...
		var productImage;
		productImage = $(productCard).find('img').get(0).src;
		var productName;

		productName = $(productCard).find('.product_name').get(0).innerHTML;
		...
		*/
		setTimeout(function () {
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + productImage + "' alt='' /></div><span>" + productName + "</span><strong id='price'>$39</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";
...
// This code calculates the total price of items in the shopping cart
// It loops through each cart item and extracts the price from the HTML
// It then adds up all the prices to get the total
// Finally, it displays the total in the HTML element with id "total-price"
